...
eventsRouter.post("/managem", authMiddleware, uploadMiddleware("picture"), eventsController.createInsertEventMobile)
eventsRouter.patch("/manage/:id", authMiddleware, uploadMiddleware("picture"), eventsController.updateEvent)
eventsRouter.patch("/managem/:id", authMiddleware, uploadMiddleware("picture"), eventsController.updateEventMobile)
